...
namespace Slots.Intents
{
    internal class OrdinalSlotCheckerIntent: AlexaIntentHandlerBase
    {
        ...
        public OrdinalSlotCheckerIntent() : base(AlexaIntentType.Custom,SkillConstants.IntentNames.OrdinalCheckerIntent)
        {
            AddSlot( SkillConstants.SlotNames.OrdinalSlotName,AlexaBuiltInSlotTypes.Ordinal, true);
            AddSampleInvocation("Give me some ordinals like first, third, or last");
        }
        ...
        public override Task ProcessAsync()
        {
            try
            {
                var slotVal = GetAlexaSlot(SkillConstants.SlotNames.OrdinalSlotName);
