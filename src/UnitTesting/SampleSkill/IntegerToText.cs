...
namespace ExactMeasureSkill
{
    static class IntegerToText
    {
        ...
        /// <returns></returns>
        public static string Convert(decimal value, bool appendFraction = false)
        {
            string digits, temp;
            ...
            var retVal = String.Format("{0}{1}", Char.ToUpper(builder[0]), builder.ToString(1, builder.Length - 1));
